...
export const PR_EXERCISES = [
  { id: 'pr_squat', labelBg: 'Клек', labelEn: 'Squat', keywords: ['клек'], muiIcon: 'FitnessCenter', type: 'weight', unit: 'kg',
    milestones: [
      ...
      { v: 20,  label: '20kg',  xp: 5 },
      { v: 30,  label: '30kg',  xp: 5 },
      { v: 40,  label: '40kg',  xp: 5 },
      { v: 50,  label: '50kg',  xp: 5 },
      { v: 60,  label: '60kg',  xp: 5 },
      { v: 70,  label: '70kg',  xp: 5 },
      { v: 80,  label: '80kg',  xp: 5 },
      { v: 90,  label: '90kg',  xp: 5 },
      { v: 100, label: '100kg', xp: 5 },
    ],
  },
