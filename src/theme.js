...
export function makeTheme(isDark) {
  ...
  return createTheme({
    ...
    typography: {
      ...
      h1: { fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700, fontSize: '2.25rem', letterSpacing: '-0.5px', lineHeight: 1.15 },
      h2: { fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700, fontSize: '1.625rem', letterSpacing: '-0.3px', lineHeight: 1.2 },
      h3: { fontWeight: 600, fontSize: '1.25rem',  letterSpacing: '-0.1px', lineHeight: 1.3 },
      h4: { fontWeight: 600, fontSize: '1.0625rem', letterSpacing: '-0.1px' },
      h5: { fontWeight: 600, fontSize: '0.9375rem' },
      h6: { fontWeight: 600, fontSize: '0.8125rem', letterSpacing: '0.05px' },
      body1:   { fontSize: '0.9375rem', letterSpacing: '0.1px', lineHeight: 1.55 },
      body2:   { fontSize: '0.875rem',  letterSpacing: '0.1px', lineHeight: 1.5 },
      caption: { fontSize: '0.75rem',   letterSpacing: '0.3px', lineHeight: 1.4 },
      overline:{ fontSize: '0.6875rem', fontWeight: 700, letterSpacing: '0.9px', textTransform: 'uppercase', lineHeight: 1.5 },
