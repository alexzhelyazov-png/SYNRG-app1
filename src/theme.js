...
const DARK = {
  ...
  primaryHover:     '#D4F2CF',
  primaryOn:        '#0A2E0F',
  primaryContainer: 'rgba(170,169,205,0.12)',
  primaryGlow:      'rgba(170,169,205,0.18)',
  primaryDeep:      '#9B99C9',
  primaryA5:        'rgba(170,169,205,0.05)',
  primaryA3:        'rgba(170,169,205,0.03)',
  primaryA13:       'rgba(170,169,205,0.13)',
  primaryA20:       'rgba(170,169,205,0.20)',
  ...
  accentSoft:       'rgba(170,169,205,0.12)',
  purple:           '#C8C5FF',
  ...
  listSelHover:     'rgba(170,169,205,0.16)',
  tooltipBg:        'rgba(21,24,22,0.97)',
  appBarBg:         'rgba(13,16,14,0.92)',
  mobileNavBg:      'rgba(13,16,14,0.97)',
  optionBg:         '#151816',
  ...
  loganDim:         'rgba(170,169,205,0.12)',
}
...
export const C = {
  ...
  logan:            'var(--c-logan)',
  loganBorder:      'var(--c-loganBorder)',
  loganDeep:        'var(--c-loganDeep)',
  loganDim:         'var(--c-loganDim)',
}
...
export function makeTheme() {
  ...
  return createTheme({
    ...
    typography: {
      ...
      h1: { fontFamily: "'MontBlanc', sans-serif", fontWeight: 800, fontSize: '2.25rem', letterSpacing: '-0.5px', lineHeight: 1.15, fontStyle: 'italic' },
      h2: { fontFamily: "'MontBlanc', sans-serif", fontWeight: 800, fontSize: '1.625rem', letterSpacing: '-0.3px', lineHeight: 1.2, fontStyle: 'italic' },
      h3: { fontFamily: "'MontBlanc', sans-serif", fontWeight: 700, fontSize: '1.25rem',  letterSpacing: '-0.1px', lineHeight: 1.3, fontStyle: 'italic' },
      h4: { fontFamily: "'MontBlanc', sans-serif", fontWeight: 700, fontSize: '1.0625rem', letterSpacing: '-0.1px', fontStyle: 'italic' },
      h5: { fontFamily: "'MontBlanc', sans-serif", fontWeight: 700, fontSize: '0.9375rem', fontStyle: 'italic' },
      h6: { fontFamily: "'MontBlanc', sans-serif", fontWeight: 600, fontSize: '0.8125rem', letterSpacing: '0.05px', fontStyle: 'italic' },
      ...
      button:  { fontFamily: "'MontBlanc', sans-serif", fontWeight: 700, fontSize: '0.875rem', letterSpacing: '0.1px', textTransform: 'none' },
    },
      ...
      MuiPaper: {
        ...
        styleOverrides: {
          root: {
            ...
            borderRadius: '24px',
            boxShadow:    'none',
            transition:   `border-color 0.25s cubic-bezier(0.4,0,0.2,1), transform 0.25s cubic-bezier(0.34,1.56,0.64,1), background 0.25s`,
            '&:hover': {
      ...
      MuiButton: {
        styleOverrides: {
          ...
          containedSecondary: {
            ...
            boxShadow:  'none',
            '&:hover': {
              background: `var(--c-purpleLighter)`,
              boxShadow:  `0 8px 32px var(--c-purpleGlow)`,
              transform:  'translateY(-2px)',
            },
          },
          containedError: {
            ...
            '&:hover': {
              ...
              boxShadow:  `0 8px 32px var(--c-dangerGlow)`,
              transform:  'translateY(-2px)',
            },
          },
          outlined: {
            borderColor: `var(--c-loganBorder)`,
            color:       `var(--c-text)`,
            background:  'transparent',
            '&:hover': {
              borderColor:     `var(--c-logan)`,
              backgroundColor: `var(--c-loganDeep)`,
              transform:       'translateY(-2px)',
            },
          },
          text: {
      ...
      MuiInputLabel: {
        styleOverrides: {
          root: {
            ...
            '&.Mui-focused': { color: `var(--c-purple)` },
          },
        },
      },
      MuiSelect: {
      ...
      MuiMenuItem: {
        styleOverrides: {
          root: {
            ...
            '&.Mui-selected': { backgroundColor: `var(--c-primaryContainer)`, color: `var(--c-purple)` },
          },
        },
      },
      ...
      MuiBottomNavigationAction: {
        styleOverrides: {
          root: {
            ...
            paddingTop: '12px',
            transition: `color 0.18s`,
            '&.Mui-selected': { color: `var(--c-purple)` },
