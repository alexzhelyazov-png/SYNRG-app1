...
const NEEDS = [
  {
    ...
    text: 'Точно това е идеята. Броенето беше само за тези 7 дни — за да видиш. Методът е за живота след това: малки, незабележими промени, без да броиш вечно и без забранени храни. Всичко с треньор до теб, лесен за спазване план и устойчиви резултати.',
  },
  {
    key: 'person',
    label: 'Човек до мен',
    text: 'Не оставаш насаме с целта си. В Метода имаш треньор, когото питаш всичко — когато се обезсърчиш, когато не знаеш какво да ядеш, когато ти се откаже. Отговаря ти човек, не приложение. Лесен за спазване план и устойчиви резултати.',
  },
  {
    key: 'activity',
    label: 'Физическа активност',
    text: 'Вътре имаш кратки тренировки от Елина — физиотерапевт в болница и треньор в студиото ни във Варна. Безопасни за тялото, без болки в кръста, по 15 минути. Няма да ти отнемат половин ден. Треньор до теб, лесен за спазване план и устойчиви резултати.',
  },
  {
    key: 'time',
    label: 'Време',
    text: 'Методът е задачи по 5–10 минути на ден, вградени в ежедневието ти. Не искаме да преобърнеш живота си — искаме да го подобрим отвътре. Треньор до теб, лесен за спазване план и устойчиви резултати.',
  },
  {
    key: 'guarantee',
    label: 'Съмнявам се, че ще проработи',
    text: GUARANTEE_TEXT + ' Треньор до теб, лесен за спазване план и устойчиви резултати.',
  },
]
