...
export default function StatCard({ label, value, accent, sub }) {
  return (
    <div style={{
      background:   accent
        ? 'linear-gradient(145deg, rgba(170,169,205,0.1) 0%, rgba(170,169,205,0.06) 100%)'
        : 'linear-gradient(145deg, #1C1A19 0%, rgba(25,23,22,0.97) 100%)',
      border:       `1px solid ${accent ? 'rgba(170,169,205,0.18)' : 'rgba(255,255,255,0.06)'}`,
      borderRadius: '16px',
      padding:      '18px 20px',
    ...
    onMouseEnter={e => {
      ...
      e.currentTarget.style.borderColor = accent ? 'rgba(170,169,205,0.28)' : 'rgba(255,255,255,0.1)'
    }}
    onMouseLeave={e => {
      e.currentTarget.style.transform   = 'translateY(0)'
      e.currentTarget.style.boxShadow   = 'none'
      e.currentTarget.style.borderColor = accent ? 'rgba(170,169,205,0.18)' : 'rgba(255,255,255,0.06)'
    }}
    >
      <div style={{
        fontSize:      '10.5px',
